        ...
        .insert([
          {
            ...
            govt_id_filename: progress.personalInfo?.govtIdFile?.originalName || '',
            govt_id_path: progress.personalInfo?.govtIdFile?.s3Key || '',
            ...
            certificate_filename: progress.educationalDetails?.certificateFile?.originalName || '',
            certificate_path: progress.educationalDetails?.certificateFile?.s3Key || '',
